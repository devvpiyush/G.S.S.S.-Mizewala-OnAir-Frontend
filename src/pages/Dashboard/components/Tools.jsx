        ...
        <div className="flex flex-col gap-2">
          ...
          <div>
            <p className="text-center font-light text-[15px] px-3">
              Marker tool developed by G.S.S.S. Mirzewala is a tool that allows
              Class Teachers to Mark attendence of Students of their class on a
              daily basic as Present or Absent.
            </p>
          </div>
        </div>
